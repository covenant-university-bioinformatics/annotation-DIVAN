...
input_file=$1 # variants or region based
output=$2
variant_type=$3  ##{known, unknown} known:scoreDIVAN.cmd.R; unkown:scoreDIVAN.cmd.genome.R
disease=$4  ##{disease}  all:batchscript
